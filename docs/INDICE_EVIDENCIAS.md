...
| 4 | Base de datos (10 %) | [`SACE_db_ddl.sql`](SACE_db_ddl.sql) (esquema completo, sin datos) · [`07-Modelo-de-Datos-y-Normalizacion-SACE.md`](07-Modelo-de-Datos-y-Normalizacion-SACE.md): relaciones, integridad y normalización 1FN/2FN/3FN · correcciones aplicadas: `schema_email_unico.sql` (correo único) y `schema_datos_corporativos.sql` (dominio @aleleotours.com) · Diccionario de datos (xlsx local) | Completo (5) |
